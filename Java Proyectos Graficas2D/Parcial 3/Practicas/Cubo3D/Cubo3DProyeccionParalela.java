...
public class Cubo3DProyeccionParalela extends JFrame {
    ...
    // Método para proyectar los puntos en 2D usando proyección paralela
    private void calcularProyeccion2D() {
        ...
        for (int i = 0; i < vertices.length; i++) {
            ...
            int x2D = (int) (x + z * Math.cos(angulo)) + offsetX;
            int y2D = (int) (y + z * Math.sin(angulo)) + offsetY;
