...
public class Cubo3DConEscalamiento extends JFrame implements KeyListener {
    ...
    private int size = 100;     // Tamaño inicial del cubo
    ...
    // Escala del cubo
    private double scaleFactor = 1.0; // Factor de escalamiento inicial

    public Cubo3DConEscalamiento() {
        setTitle("Cubo 3D con Proyección en Perspectiva y Escalamiento");
        setSize(500, 500);
    ...
    private void calcularProyeccion2D() {
        ...
        for (int i = 0; i < vertices.length; i++) {
            // Aplicar el escalamiento a los vértices
            int x = (int) (vertices[i][0] * scaleFactor);
            int y = (int) (vertices[i][1] * scaleFactor);
            int z = (int) (vertices[i][2] * scaleFactor);
    ...
    // Implementación del KeyListener para controlar el escalamiento con el teclado
    @Override
    public void keyPressed(KeyEvent e) {
        int keyCode = e.getKeyCode();
        switch (keyCode) {
            case KeyEvent.VK_PLUS: // Tecla "+"
                scaleFactor += 0.1;
                break;
            case KeyEvent.VK_MINUS: // Tecla "-"
