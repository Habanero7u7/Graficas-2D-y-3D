...
public class Cubo3DConRotacionAutomatica extends JFrame implements Runnable {
    ...
    public Cubo3DConRotacionAutomatica() {
        setTitle("Cubo 3D con Rotación Automática");
        setSize(500, 500);
    ...
    public static void main(String[] args) {
        new Cubo3DConRotacionAutomatica();
    }
}
